...
float pidControl(long leftTicks, long rightTicks) {
...
void loop() {
  ...
  float correction = pidControl(leftTicks, rightTicks);

  float leftSpeed  = baseSpeed + offset - correction;
  float rightSpeed = baseSpeed - offset + correction;
